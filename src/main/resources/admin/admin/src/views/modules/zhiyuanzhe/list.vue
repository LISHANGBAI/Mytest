		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0px 0 0","borderRadius":"20px","background":"rgba(255,255,255,1)"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<!-- $column.hiden -->
					<!-- 无 -->
					<el-table-column :resizable='true' :sortable='true' prop="zhengjianzhao" width="200" label="证件照">
						<template slot-scope="scope">
							<div v-if="scope.row.zhengjianzhao">
								<img v-if="scope.row.zhengjianzhao.substring(0,4)=='http'" :src="scope.row.zhengjianzhao.split(',')[0]" width="100" height="100" style="object-fit: cover">
								<img v-else :src="$base.url+scope.row.zhengjianzhao.split(',')[0]" width="100" height="100" style="object-fit: cover">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>

	...
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="服务状态" prop="fuwuzhuangtai">
					<el-input v-model="ruleForm.fuwuzhuangtai"  placeholder="服务状态" clearable  :readonly="ro.fuwuzhuangtai"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="服务状态" prop="fuwuzhuangtai">
					<el-input v-model="ruleForm.fuwuzhuangtai" placeholder="服务状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="服务时间" prop="fuwushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.fuwushijian" label="服务时间" prop="fuwushijian">
...
export default {
	...
	created() {
		this.ruleForm.fuwushijian = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.fuwuzhuangtai = '服务中'; 

<template>
	<div class="main-content" :style='{"padding":"0px 30px 30px","fontSize":"14px","color":"#666","background":"none"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('fuwuxinxi','完成服务')" @click="fuwuwanchengCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<fuwuwancheng-cross-add-or-update v-if="fuwuwanchengCrossAddOrUpdateFlag" :parent="this" ref="fuwuwanchengCrossaddOrUpdate"></fuwuwancheng-cross-add-or-update>
...
import fuwuwanchengCrossAddOrUpdate from "../fuwuwancheng/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				fuwuwanchengCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			fuwuwanchengCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.fuwuwanchengCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.fuwuwanchengCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.fuwuwanchengCrossaddOrUpdate.init(row.id,type);
				});
			},

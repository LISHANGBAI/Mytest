...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="证件照" v-if="type!='cross' || (type=='cross' && !ro.zhengjianzhao)" prop="zhengjianzhao">
            <file-upload
            tip="点击上传证件照"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' class="upload" v-else label="证件照" prop="zhengjianzhao">
                ...
                <img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhengjianzhao.split(',')" :src="baseUrl+item" width="100" height="100">
            </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="时间币" prop="shijianbi">
            <el-input v-model.number="ruleForm.shijianbi" 
                placeholder="时间币" clearable :disabled="true  ||ro.shijianbi"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="服务等级" prop="fuwudengji">
            <el-select v-model="ruleForm.fuwudengji" placeholder="请选择服务等级" :disabled="true  ||ro.fuwudengji" >
              <el-option
  ...
  export default {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='zhengjianzhao'){
              this.ruleForm.zhengjianzhao = obj[o].split(",")[0];
    ...
    // 多级联动参数
      ...
      zhengjianzhaoUploadChange(fileUrls) {
          this.ruleForm.zhengjianzhao = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
    }
  };
</script>

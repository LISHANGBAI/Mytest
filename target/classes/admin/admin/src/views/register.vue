	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","border":"30px solid #ffc054","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231107/de423fd8df8f4765b7a00108faf7266e.jpg)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center bottom","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
			<el-form v-if="pageFlag=='register'" :style='{"border":"0px solid #f6f6f6","minHeight":"calc(100vh - 60px)","padding":"20px 60px 20px 120px","margin":"0","borderRadius":"0px","textAlign":"center","background":"#fff","width":"38vw","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"padding":"0px","margin":"0px auto 20px","borderColor":"#ffbb43","color":"#ffbb43","textAlign":"center","display":"inline-block","background":"#fff","borderWidth":"0 0 2px","width":"100%","lineHeight":"40px","fontSize":"20px","borderStyle":"solid","fontWeight":"500"}' class="title">志愿者服务平台注册</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 15px","textAlign":"left","flexWrap":"wrap","display":"block","width":"100%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='yonghu'">
					<div v-if="true" :style='{"padding":"0 10px","color":"#002355","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('dianhuahaoma')?'required':''">电话号码：</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 15px","textAlign":"left","flexWrap":"wrap","display":"block","width":"100%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='zhiyuanzhe'">
					<div v-if="true" :style='{"padding":"0 10px","color":"#002355","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('zhiyuanzhezhanghao')?'required':''">志愿者账号：</div>
					<el-input  v-model="ruleForm.zhiyuanzhezhanghao"  autocomplete="off" placeholder="志愿者账号"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 15px","textAlign":"left","flexWrap":"wrap","display":"block","width":"100%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='zhiyuanzhe'">
					<div v-if="true" :style='{"padding":"0 10px","color":"#002355","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('zhiyuanzhexingming')?'required':''">志愿者姓名：</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 15px","textAlign":"left","flexWrap":"wrap","display":"block","width":"100%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='zhiyuanzhe'">
					<div v-if="true" :style='{"padding":"0 10px","color":"#002355","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('zhengjianzhao')?'required':''">证件照：</div>
                    <file-upload
                        tip="点击上传证件照"
                        action="file/upload"
                        :limit="3"
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 15px","textAlign":"left","flexWrap":"wrap","display":"block","width":"100%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='zhiyuanzhe'">
					<div v-if="true" :style='{"padding":"0 10px","color":"#002355","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('fuwudengji')?'required':''">服务等级：</div>
                    <el-select v-model="ruleForm.fuwudengji" placeholder="请选择服务等级" :disabled="true">
                        <el-option
		...
		login() {
            ...
            if(this.ruleForm.zhengjianzhao!=null) {
                this.ruleForm.zhengjianzhao = this.ruleForm.zhengjianzhao.replace(new RegExp(this.$base.url,"g"),"");
					...
					if(`zhiyuanzhe` == this.tableName && this.ruleForm.dianhuahaoma &&(!this.$validate.isMobile(this.ruleForm.dianhuahaoma))){
						this.$message.error(`电话号码应输入手机格式`);
						return
					}
			this.$http({

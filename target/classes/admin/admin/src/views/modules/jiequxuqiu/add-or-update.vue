<template>
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="接取编号" prop="jiequbianhao">
					<el-input v-model="ruleForm.jiequbianhao" placeholder="接取编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.jiequbianhao" label="接取编号" prop="jiequbianhao">
					<el-input v-model="ruleForm.jiequbianhao" placeholder="接取编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="接取时间" prop="jiequshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.jiequshijian" label="接取时间" prop="jiequshijian">
					<el-input v-model="ruleForm.jiequshijian" placeholder="接取时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="服务等级" prop="fuwudengji">
					<el-input v-model="ruleForm.fuwudengji"  placeholder="服务等级" clearable  :readonly="ro.fuwudengji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="服务等级" prop="fuwudengji">
					<el-input v-model="ruleForm.fuwudengji" placeholder="服务等级" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.fuwudengji!=''&&json.fuwudengji) || json.fuwudengji==0) && this.$storage.get("role")!="管理员"){
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `jiequxuqiu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.jiequxuqiuCrossAddOrUpdateFlag = false;
											this.parent.search();

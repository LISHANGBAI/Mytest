...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="服务状态" prop="fuwuzhuangtai">
            <el-input v-model="ruleForm.fuwuzhuangtai" 
                placeholder="服务状态" clearable :disabled=" false  ||ro.fuwuzhuangtai"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="服务时间" prop="fuwushijian">
              <el-date-picker
